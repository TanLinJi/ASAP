#!/usr/bin/env bash
# Evaluate PointPillars on all 3 ASAP-hybrid purified KITTI val sets.
set -euo pipefail
...
echo "[$(date +%H:%M:%S)] All ASAP hybrid evaluations complete."
