#!/usr/bin/env bash
# Evaluate PointPillars on all 3 ASAP-vp_sde purified KITTI val sets.
set -euo pipefail
...
echo "[$(date +%H:%M:%S)] All ASAP vp_sde evaluations complete."
